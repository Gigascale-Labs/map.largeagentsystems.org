...
export default function Home() {
  return (
    <div className="content-container">
      <div className="w-layout-grid flex padding-top-56px padding-bottom-80px">
      ...
      <div className={styles.cardFullWidth2}>
      ...
      <div className={styles.cardFullWidth3}>
        <div>
      ...
      <div className={styles.cardsGrid}>
        ...
        <div className={styles.cardHalfWidth4}>
          ...
          <div className={styles.cardHalfWidthBottomCardLight}>
            ...
            <div className="flex-horizontal_center flex-gap-8px padding-bottom-24px">
              <Image
                loading="lazy"
      ...
      <div className={styles.cardsGridThirds}>
